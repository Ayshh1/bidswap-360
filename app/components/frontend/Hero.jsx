    ...
    return (
        ...
        <div className="col-span-2 hidden space-x-3 sm:block bg-white p-3 dark:bg-slate-800 rounded-lg ">
            <Link className="flex items-center space-x-1 mb-3" href="/">
                <HelpCircle className="shrink-0 w-5 h-5 dark:text-cyan-500 text-slate-900" />
            ...
            <Link className="flex items-center space-x-1 mb-3" href="/">
                <FolderSync className="shrink-0 w-5 h-5 dark:text-cyan-500 text-slate-900" />
                <div className="flex flex-col">
            ...
            <Link className="flex items-center space-x-1 " href="/register-farmer">
                <CircleDollarSign className="shrink-0 w-5 h-5 dark:text-cyan-500 text-slate-900 mb-6" />
                <div className="flex flex-col">
